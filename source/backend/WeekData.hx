...
typedef WeekFile =
{
	...
	var galamix:Null<Bool>;
	var weekCharacter:Null<String>;
}
...
class WeekData {
	...
	public function new(weekFile:WeekFile, fileName:String) {
		...
		galamix = weekFile.galamix == null ? false : weekFile.galamix;
		weekCharacter = weekFile.weekCharacter == null ? "" : weekFile.weekCharacter;
