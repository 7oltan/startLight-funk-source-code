...
class CharacterEditorState extends MusicBeatState
{
	...
	function reloadBGs() {
		...
		bgLayer.add(new FlxSprite(425,700).makeGraphic(400,50,FlxColor.RED));
	}
	...
	function addSettingsUI() {
		...
		var templateCharacter:FlxButton = new FlxButton(140, 50, "Load Template", function()
		{
			...
			for (character in characters)
			{
				...
				character.healthBar = parsedJson.health_bar;
	...
	var healthBarInputText:FlxUIInputText;
	...
	function addCharacterUI() {
		...
		healthBarInputText = new FlxUIInputText(105, imageInputText.y + 35, 75, char.healthBar, 8);
		...
		tab_group.add(new FlxText(105, healthBarInputText.y - 18, 0, 'Health bar name:'));
		...
		tab_group.add(healthBarInputText);
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>) {
		if(id == FlxUIInputText.CHANGE_EVENT && (sender is FlxUIInputText)) {
			...
			else if(sender == healthBarInputText) {
				char.healthBar = healthBarInputText.text;
			}
	...
	function reloadCharacterOptions() {
		if(UI_characterbox != null) {
			...
			healthBarInputText.text = char.healthBar;
	...
	override function update(elapsed:Float)
	{
		...
		var inputTexts:Array<FlxUIInputText> = [animationInputText, imageInputText, healthIconInputText, healthBarInputText, animationNameInputText, animationIndicesInputText];
