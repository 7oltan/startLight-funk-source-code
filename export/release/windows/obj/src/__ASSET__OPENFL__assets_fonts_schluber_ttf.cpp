...
HX_DEFINE_STACK_FRAME(_hx_pos_66de3d1e457bb5fd_862_new,"__ASSET__OPENFL__assets_fonts_schluber_ttf","new",0xe405d8fe,"__ASSET__OPENFL__assets_fonts_schluber_ttf.new","ManifestResources.hx",862,0xf77aa668)

void __ASSET__OPENFL__assets_fonts_schluber_ttf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_66de3d1e457bb5fd_862_new)
HXDLIN( 862)		this->_hx___fontPath = (::ManifestResources_obj::rootPath + HX_("assets/fonts/Schluber.ttf",dd,e5,6f,b0));
HXDLIN( 862)		this->name = HX_("Schluber",ae,c5,2c,b2);
