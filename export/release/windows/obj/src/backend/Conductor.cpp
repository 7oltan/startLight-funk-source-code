...
HX_LOCAL_STACK_FRAME(_hx_pos_080e9a5446946e07_142_set_bpm,"backend.Conductor","set_bpm",0xce0bee01,"backend.Conductor.set_bpm","backend/Conductor.hx",142,0x5443f372)
...
Float Conductor_obj::set_bpm(Float newBPM){
            	HX_STACKFRAME(&_hx_pos_080e9a5446946e07_142_set_bpm)
HXLINE( 143)		::backend::Conductor_obj::bpm = newBPM;
HXLINE( 144)		::backend::Conductor_obj::crochet = ((( (Float)(60) ) / ::backend::Conductor_obj::bpm) * ( (Float)(1000) ));
HXLINE( 145)		::backend::Conductor_obj::stepCrochet = (::backend::Conductor_obj::crochet / ( (Float)(4) ));
HXLINE( 147)		return (::backend::Conductor_obj::bpm = newBPM);
            	}
