...
class HXCPP_CLASS_ATTRIBUTES SoundFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		::Dynamic playMusic_dyn();
		 ...
		 ::flixel::sound::FlxSound load( ::Dynamic embeddedSound,::hx::Null< Float >  volume,::hx::Null< bool >  looped, ::flixel::_hx_system::FlxSoundGroup group,::hx::Null< bool >  autoDestroy,::hx::Null< bool >  autoPlay,::String url, ::Dynamic onComplete, ::Dynamic onLoad);
		::Dynamic load_dyn();

		 ::flixel::sound::FlxSound loadHelper( ::flixel::sound::FlxSound sound,Float volume, ::flixel::_hx_system::FlxSoundGroup group,::hx::Null< bool >  autoPlay);
		...
		::Dynamic cacheAll_dyn();
		 ...
		 ::flixel::sound::FlxSound play( ::Dynamic embeddedSound,::hx::Null< Float >  volume,::hx::Null< bool >  looped, ::flixel::_hx_system::FlxSoundGroup group,::hx::Null< bool >  autoDestroy, ::Dynamic onComplete);
		::Dynamic play_dyn();

		 ::flixel::sound::FlxSound stream(::String url,::hx::Null< Float >  volume,::hx::Null< bool >  looped, ::flixel::_hx_system::FlxSoundGroup group,::hx::Null< bool >  autoDestroy, ::Dynamic onComplete, ::Dynamic onLoad);
		::Dynamic stream_dyn();
